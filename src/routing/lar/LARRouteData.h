...
#ifndef __INET_LARROUTEDATA_H
#define __INET_LARROUTEDATA_H
...
class INET_API LARRouteData : public cObject
{
  protected:
...
std::ostream& operator<<(std::ostream& out, const LARRouteData *data);

} // namespace inet

#endif    // ifndef LARROUTEDATA_H_
