...
#ifndef __INET_AODVBRROUTING_H
#define __INET_AODVBRROUTING_H
...
class INET_API AODVBRRouting : public cSimpleModule, public ILifecycle, public INetfilter::IHook, public cListener
{
private:
  ...
  public:
    AODVBRRouting();
    virtual ~AODVBRRouting();
};

} // namespace inet

#endif    // ifndef AODVBRROUTING_H_
