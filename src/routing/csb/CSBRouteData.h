...
#ifndef __INET_CSBROUTEDATA_H
#define __INET_CSBROUTEDATA_H
...
class INET_API CSBRouteData : public cObject
{
  protected:
...
std::ostream& operator<<(std::ostream& out, const CSBRouteData *data);

} // namespace inet

#endif    // ifndef CSBROUTEDATA_H_
